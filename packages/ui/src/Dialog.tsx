    ...
    >
      ...
      >
        <DialogPrimitive.Close
          ...
          className="absolute top-3 right-3 z-10 inline-flex h-8 w-8 items-center justify-center rounded-md text-[var(--text-muted)] opacity-70 transition hover:opacity-100 hover:bg-[var(--surface-2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)]"
        >
